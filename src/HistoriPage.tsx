            ...
            <div className='mb-6'>
              <div className='rounded-lg border bg-white shadow-sm p-6'>
                ...
                <p className='text-sm text-muted-foreground mb-4'>
                  Info: Rentang aman detak jantung (BPM) setiap orang berbeda,
                  terutama dipengaruhi oleh berat badan, dengan perbedaan
                  rata-rata sekitar 23%.
                  ...
                  Jika terjadi{" "}
                  <strong>
                    penurunan drastis detak jantung hingga sekitar 30% dari
                    nilai rata-rata harian
                  </strong>
                  , hal ini dapat menandakan adanya gangguan pada fungsi jantung
                  dan perlu mendapat perhatian medis.
                </p>
